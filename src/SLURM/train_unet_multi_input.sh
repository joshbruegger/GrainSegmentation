...
NUM_INPUTS=${NUM_INPUTS:-7}
IMAGE_SUFFIXES=${IMAGE_SUFFIXES:-"_PPL,_PPX1,_PPX2,_PPX3,_PPX4,_PPX5,_PPX6"}
RUN_NAME=${RUN_NAME:-"7in_PPL_AllPPX"}
OUTPUT_MODEL=${OUTPUT_MODEL:-"$SCRATCH/GrainSeg/models/unet_finetuned_${RUN_NAME}.keras"}
